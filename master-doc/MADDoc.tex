...
Dieser Befehl benötigt \textbf{-id} als Parameter. Als Argument muss die Identifikationszahl des Jobs angegeben werden. Jobs, die während der Ausführung dieses Befehles in Ausführung sind, können nicht entfernt werden.
