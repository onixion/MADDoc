...
\item Hardwareadresslänge, 1 byte\\
Die Länge der aufgelösten Adresse. Für Ethernet ist sie 6.
\item Protokolladresslänge, 1 byte\\
...
\item Quell MAC-Adresse, 6 bytes
\item Quell IP-Adresse, 4 bytes
\item Ziel MAC-Adresse, 6 bytes\\
Enthält FF:FF:FF:FF:FF:FF, die Layer2 Broadcast Adresse.
\item Ziel IP-Adresse, 4 bytes
\end{itemize}
