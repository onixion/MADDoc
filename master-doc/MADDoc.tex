...
CLI steht für 'Command Line Interface' (=text-basierende Schnittstelle) und darunter versteht man Schnittstellen, die für die Interaktion mit dem Betriebssystem zeilenweise Befehle in Form von Text einliest, interpretiert und anschließend ausführt. Programme, die diese Schnittstelle anbieten, werden 'CLI-Interpreter' genannt, da sie die Eingabe interpretieren. Bei Unix-ähnlichen Betriebssystemen hat sich auch der Begriff 'Shell' für einen CLI-Interpreter eingebürgert. Bekannte CLI-Interpreter sind zum Beispiel 'sh', 'bash' und 'Windows PowerShell'. (vgl. http://de.wikipedia.org/wiki/Kommandozeile http://de.wikipedia.org/wiki/Unix-Shell)
...
Die aller ersten Computer unterstützten keine Interaktive Input/Output Geräte und daher war die Überwachung von Programmen nur mithilfe von Kontrolllampen und Schaltern möglich. Ab 1960 wurden die Textbasierten Schnittstellen für die Interaktion eingeführt. Mithilfe von Terminals, wie der 'Teletype Model 33 ASR', konnte die Instruktionen auf Lochkarten gestanzt werden und vom Computer gelesen werden. (vgl. http://en.wikipedia.org/wiki/Command-line\_interface) \\

(BILD http://upload.wikimedia.org/wikipedia/commons/3/33/Teletype-IMG\_7287.jpg)

Anfangs der 1970er Jahre begann das Unternehmen 'Bell Labs' die Entwicklung eines Betriebssystems namens Unix. Unix besaß eine mächtige CLI-Umgebung, konnte durch sogenannte 'Pipes' die Ausgaben von Programmen umleiten und konnte 'Scripts' ausführen.\\

Auch andere Computer, wie zum Beispiel 'Commodore PET',oder Apple II, besaßen für die Interaktion einfache CLI-Interpreter.\\
