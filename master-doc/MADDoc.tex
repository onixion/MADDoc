...
%\begin{center}
%\begin{frame}
%Bild hier \includegraphics[scale=0.5]{./docs/tarkes/pics/RouterNetwork.jpg}
%\end{frame}
%\end{center}
...
Auf dem Bild wären die Netze 192.168.11.0 192.168.12.0 und 192.168.22.0 dem Router1 also ohne weiteres bekannt und er könnte Anfragen von Host221 an Host211 ohne Probleme weiterleiten.
