...
In CLI-Anwendungen lassen sich viel mehr Einstellungen vornehmen als bei grafischen Anwendungen, ein gutes Beispiel hierführ ist der C/C++ Compiler 'gcc'. Eine grafische Oberfläche für die Benutztung dieses Compilers müsste enorm viele Einstellungen und Textfelder bieten, um den Compiler bis ins Detail zu konfigurieren. Da die Umsetzung einer Oberfläche für den 'gcc' seh schwierig und auch sinnlos ist, werden in modernen IDEs einfach eine Konsole eingebaut, die für die Verwendung des Compilers verwendet wird.\\
...
Sehr erfahrene Nutzer arbeiten ausschließlich über die textbasierende Schnittstelle, da sie direkte Kontrolle über alle Funktionen haben. Die Ausgabe der Fehlermeldungen sind sehr übersichtlich und erfahrende Nutzer können effizienter arbeiten.
...
Mit Kryptographie ist die Entwicklung von kryptografischen Systemen gemeint. Diese Systeme sind mathematische Verfahren die Informationen manipulieren. Die Manipulation der Informationen hängt vom gewählten Schlüssel ab.

Der 'Cipher' ist der Verschlüsselungs-Algorithmus (AUF DIE GRUNDBEGRIFFE EINGEHEN + BILD) 
