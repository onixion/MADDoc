...
%\end{Huge}
%\vspace{1cm}
%Alin Porcic, Daniel Ranalter, Manpreet Singh, Marko Stojanovi\'{c}\\
%\today\\
%\vspace{10cm}
%\begin{tabular}{l|l}
%Betreuer: & Prof.Dr. Michael Weiss\\
%Klasse: & 5BHEL
%\end{tabular}\\
%\vspace{2cm}
%Höhere Technische Bundes Lehr- und Versuchsanstalt Anichstraße\\
...
\section{Allgemein}
Die elektronische Post ist ein sehr wichtiger Teil des heutigen Systems. Jeder hat eine E-Mail-Adresse, sei es der Großvater oder auch die wichtige Geschäftsfrau. E-Mails ermöglichen nun schon seit geraumer Zeit, sowohl das Senden als auch das Empfangen von Text, Dokumenten, Bildern, etc.. Es gibt auch andere Systeme, aber das System der E-Mail ist davon, als Gesamtpaket betrachtet, wohl das einfachste und auch praktischste.\\\\
...
\newpage
\lfoot{Manpreet Singh}
\section{Grahpical User Interface (Manpreet Singh)}
...
GUIs (Graphical User Interface) werden auch viel in Firmen eingesetzt um Personal, welches der Informationstechnik nicht sehr mächtig ist, trotzdem eine Möglichkeit zu bieten darauf zuzugreifen.
\subsection{Geschichte}
Diese Geschichte beginnt in Kalifornien bei der Firma Xerox in den 1970er Jahren. Dort wurde erstmals an Graphischen Oberflächen gearbeitet. Nach langer Entwicklungsphase, kam der Xerox Star auf den Markt. Dieser schaffte jedoch nicht den erhofften Durchbruch. Die Firma Apple präsentierte 1983 ihren ersten Computer mit graphischer Oberfläche. Er trug den Namen 'Apple Lisa' und war viel zu teuer. Der Apple Macintosh aus dem Jahre 1984 war Apples Durchbruch. Er wurde unter Steve Jobs Leitung entwickelt. \\\\
...
Die Entwicklung der GUI war sehr stark abhängig von der Entwicklung der Hardware, denn wenn keine Leistung vorhanden ist, kann es auch keine aufwendige Software geben.\\

Aber da die Entwicklung in den letzten 10 bis 15 Jahren nahezu exponentiell Angestiegen ist, ist heute auch genug Leistung vorhanden und komplizierte graphische Programme können problemlos produziert werden. (vgl. http://de.wikipedia.org/wiki/Grafische\_Benutzeroberfläche\#Geschichte)
...
Die Benutzeroberfläche ist die Schnittstelle zum System. Auf dieser kann der Benutzer interagieren.
\begin{center}
...
\end{scriptsize}
\end{center}
In der obigen Abbildung wird ein Aufbau gezeigt, der üblich ist bei Linux Systemen. \\
Erklärung zu den einzelnen Schichten:\\
\begin{itemize}
\item \textbf{Hardware}\\
Die Hardware kann durchaus varieren. Es gibt unzählige Hersteller für Grafikkarten. Auch Prozessoren-Hersteller haben bereits integrierte Grafikkarten in ihren Prozessoren verbaut, sogenannte 'Onboard Grafikarten'
\item \textbf{Kernel}
Als Kernel wird das System bezeichnet, auf dem alles aufbaut. Z.B. Der Linux Kernel
...
Die Grafische Shell kommuniziert mit dem Anzeige Server und sagt diesem was er darstellen soll. Z.B. KDE, Gnome
\item \textbf{Benutzer}
Schlussendlich kommt der Benutzer, welcher jetzt mit Komfort seinen Rechner bedienen kann.
\end{itemize}
\subsection{Normen}
...
beschreibt wie gut sich das Produkt für den Einsatz eignet.
\item Selbstbeschreibungsfähigkeit\\
beschreibt die Orientierbarkeit im Produkt.
\item Steuerbarkeit\\
beschreibt wie gut das Produkt zu steuern ist.
\item Erwartungskonformität\\
beschreibt die Beibehaltung eines durchgehenden Stilles.
\item Fehlertoleranz\\
beschreibt wie gut das Produkt mit eventuellen Fehlern (Systemfehler, Benutzereingabefehler,...) umgehen kann.
\item Individualisierbarkeit\\
beschreibt wie sehr ein Benutzer die Oberfläche anpassen (Farben, Größe,...) kann.
\item Lernförderlichkeit\\
beschreibt wie gut das Produkt dem Benutzer dabei hilft, dessen Qualifikationen zu erweitern.
\end{itemize}
