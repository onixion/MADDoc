...
\section{Protokolle}
lorem ipsum
\subsection{Ethernet}\label{sssec:eth}
lorem ipsum
\subsection{Address Resolution Protocol - ARP}\label{sssec:arp}
lorem ipsum
\subsubsection{Sicherheitsaspekte}
lorem ipsum
\subsection{Internet Protocol - IP}\label{sssec:ip}
lorem ipsum
\subsubsection{IPv4}
lorem ipsum
\subsubsection{IPv6}
...
lorem ipsum
\subsection{MAC-Spoofing}\label{sssec:mspoof}
lorem ipsum
\subsection{MAC-Flooding}\label{sssec:mflood}
lorem ipsum
