...
Obwohl der Einsatz von textbasierten Schnittstellen nachgelassen hat, finden sie immer noch Verwendung. Einige Betriebssysteme (Windows, Mac OS, ...) aber auch Programme (QEMU, Game-Engines, ...) bieten neben ihren graphischen Oberflächen auch alternativ textbasierte Schnittstellen an. Bei 'Embedded Systems' werden auch häufig auf CLIs zurückgegriffen, da sie sehr Ressourcen arm sind, aber auch Android-Smartphones und einigen Router und Switches machen sich die Vorteile der CLI zu nutze.(vgl. http://en.wikipedia.org/wiki/Command-line_interface#Early_history)
